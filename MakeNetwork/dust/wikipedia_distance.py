...
if __name__ == "__main__":
	...
	with open(os.path.join(INPUT,target.split(".")[0] + "_cos.txt"),'w',encoding='UTF-8') as f_cos:
		f_cos.write(target + "\n\n")
	...
	with open(os.path.join(INPUT,target.split(".")[0] + "_euclid_indec.txt"),'w',encoding='UTF-8') as f_euclid_index:
